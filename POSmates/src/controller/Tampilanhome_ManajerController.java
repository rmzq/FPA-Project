 ...
 * @author User
 */
public class Tampilanhome_ManajerController implements Initializable {
    ...
    @FXML
    private void btn_datakaryawan(ActionEvent event) throws IOException {
        System.out.println("data karyawan");
        Parent tableViewParent = FXMLLoader.load(getClass().getResource("/view/data_Karyawan.fxml"));
        Scene tableViewScene = new Scene(tableViewParent);
        Stage window = (Stage)((Node)event.getSource()).getScene().getWindow();
